...
class GLBScene {
    ...
    calculateFloorBoundaries() {
        ...
        const forwardTestRay = new Ray(new Vector3(floorCenter.x, floorCenter.y + 10, floorCenter.z + testDistance), // High above, forward position
        new Vector3(0, -1, 0) // Direction: straight down
        );
        const backwardTestRay = new Ray(new Vector3(floorCenter.x, floorCenter.y + 10, floorCenter.z - testDistance), // High above, backward position  
        new Vector3(0, -1, 0) // Direction: straight down
        );
